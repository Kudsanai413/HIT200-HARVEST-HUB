			...
			button_type ?
				{
					...
					: {...custom.rect_button, backgroundColor: color ? color : app_colors.white}
		]}
    >
    	<View style={ button_type ? custom.circular_button : [] }>
    	{
				type ? <FontAwesome5 name={ icon } size={24} color={ app_colors.fade }/>
					: <MaterialCommunityIcons name={ icon } size={24} color={ app_colors.fade }/>
