  ...
  return (
    <View style={ header.header }>
        ...
        <View style={ header.headerLowerBand }>
            <View style={ header.headerTextBox }>
                <AntDesign name='search1' color={ app_colors.tetiary } size={20}/>
                <TextInput
                    placeholder={`Search ${page}`}
                    placeholderTextColor={ app_colors.tetiary }
                    ...
                    onFocus={ () => {if (setFocus) setFocus(true)} }
                    onBlur={ () => {if (setFocus) setFocus(false)}}
                />
            </View>
